        ...
        <div class="col-md-4 order-md-2 mb-4">
        	<form id="agregar" name="agregar" method="post" action="<?=base_url()?>index.php/clientes/verificar_cliente">
	      	 ...
	      	 <div class="col-md-12 mb-3">
	              ...
	              <input type="email" class="form-control" id="verifica_email" name="verifica_email" placeholder="you@example.com" required="">
	            </div>

	            <div class="col-md-12 mb-3">
	              <label for="address">TELEFONO</label>
	              <input type="text" class="form-control" id="verifica_telefono" name="verifica_telefono" placeholder="" required="">
	            </div>
