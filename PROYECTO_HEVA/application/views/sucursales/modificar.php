			...
			<tbody>
				<td colspan="3">
					...
					<div class="form-group">
						<label>Nombre:</label>
						<input type="text" name="nombre" class="form-control" maxlength="25" value="<?=$nombre?>" required>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label>Ciudad:</label>
						<input type="text" name="ciudad" class="form-control" maxlength="50" value="<?=$ciudad?>" required>
					</div>
					<div class="form-group">
						<label>Telefono:</label>
						<input type="text" name="telefono" class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" maxlength="10" value="<?=$telefono?>" maxlength="30" required>
					</div>
					<div class="form-group">
