			...
			<tbody>
				<td colspan="3">
					...
					<div class="form-group">
						...
						<input type="text" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" maxlength="7" name="porciones" class="form-control" value="<?=$porciones?>" required>
					</div>
					<div class="form-group">
						<label>Precio:</label>
